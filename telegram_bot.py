...
import aiogram
import my_token
from routers import help,start_end_info, post_info
...
>>>>>>> 18d40122feab0fa5c676616d1da07964032b538e
async def main():
    bot = aiogram.Bot(token=my_token.my_token)
    dp = aiogram.Dispatcher()
    dp.include_routers(help.router, start_end_info.router, post_info.router)
